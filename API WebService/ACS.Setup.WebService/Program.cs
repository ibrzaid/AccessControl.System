...
using ACS.Setup.WebService.Middleware;
using ACS.Setup.WebService.Notification;
using ACS.Setup.WebService.Services.V1.Interfaces;
using ACS.Setup.WebService.Services.V1.Services;
using ACS.Swagger;
...
builder.Services.AddSingleton<IHierarchyAccessService, HierarchyAccessService>();
builder.Services.AddSingleton<IAccessPointService, AccessPointService>();
builder.Services.AddSingleton<IAreaService, AreaService>();
builder.Services.AddSingleton<IHardwareService, HardwareService>();
builder.Services.AddSingleton<IProjectService, ProjectService>();
builder.Services.AddSingleton<IZonesService, ZonesService>();
...
app.MapHub<NotificationHub>("/setup");
app.MapControllers();
