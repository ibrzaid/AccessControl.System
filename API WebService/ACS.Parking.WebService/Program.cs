    ...
    .AddJwtBearer(options =>
    {
        ...
        options.Events = new JwtBearerEvents()
        {
            OnMessageReceived = context =>
            {
                ...
                if (path.StartsWithSegments("/parking"))
                {
...
builder.Services.AddSingleton<IProjectSessionService, ProjectSessionService>();
builder.Services.AddSingleton<IBaseService, BaseService>();
builder.Services.AddSingleton<IAccessPointSessionService, AccessPointSessionService>();
builder.Services.AddSingleton<INotificationService, NotificationService>();
builder.Services.AddSingleton<IDashboardService, DashboardService>();



builder.Services.AddSingleton<AccesspointDataLoader>();
builder.Services.AddSingleton<ParkingSessionDataLoader>();
builder.Services.AddSingleton<ProjectSessionsDataLoader>();
builder.Services.AddSingleton<ZoneSessionsDataLoader>();
...
builder.Services.AddGraphQL(option =>
{
    ...
    option.AddUserContextBuilder<Dictionary<string, object?>>(httpContext =>
    {
        var findClaimHelper = httpContext.RequestServices.GetRequiredService<FindClaimHelper>();
        return new Dictionary<string, object?>
        {
            ["HttpContext"] = httpContext,
            ["User"] = httpContext.User,
            ["WorkspaceId"] = findClaimHelper.FindClaim(httpContext, "wid"),
...
app.MapHub<NotificationHub>("/parking");
app.MapControllers();
