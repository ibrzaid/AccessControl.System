...
using ACS.ANPR.WebService.Handler.V1;
using ACS.ANPR.WebService.Middleware;
using ACS.Cache.Service.V1.Interfaces;
using Microsoft.IdentityModel.Logging;
using ACS.ANPR.WebService.Notification;
...
using ACS.ANPR.WebService.Services.V1.Services;
...
{
    options.SwaggerDoc("v1", new OpenApiInfo() { Title = "ANPR Integration", Version = "v1", Description = "ANPR Integration", });
    ...
    .AddJwtBearer(options =>
    {
        ...
        options.Events = new JwtBearerEvents()
        {
            OnMessageReceived = context =>
            {
                ...
                if (path.StartsWithSegments("/anpr"))
                {
...
builder.Services.AddSingleton<IAnprService, AnprService>();
...
app.MapHub<NotificationHub>("/anpr");
app.MapControllers();
