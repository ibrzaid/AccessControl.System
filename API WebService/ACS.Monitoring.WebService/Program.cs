...
using ACS.Monitoring.WebService.Middleware;
using ACS.Monitoring.WebService.Notification;
using ACS.Monitoring.WebService.Services.V1.Interfaces;
using ACS.Monitoring.WebService.Services.V1.Services;
...
{
    options.SwaggerDoc("v1", new OpenApiInfo() { Title = "Monitoring Integration", Version = "v1", Description = "Monitoring Integration", });
    ...
    .AddJwtBearer(options =>
    {
        ...
        options.Events = new JwtBearerEvents()
        {
            OnMessageReceived = context =>
            {
                ...
                if (path.StartsWithSegments("/monitoring"))
                {
...
app.MapHub<NotificationHub>("/monitoring");
app.MapControllers();
