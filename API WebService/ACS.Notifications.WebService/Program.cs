...
using ACS.Notifications.WebService.Services.V1.Services;
...
{
    options.SwaggerDoc("v1", new OpenApiInfo() { Title = "Notifications Integration", Version = "v1", Description = "Notifications Integration", });
